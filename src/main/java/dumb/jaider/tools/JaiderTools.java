...
public class JaiderTools {
    ...
    @Tool(name = "proposeSelfUpdate",
          description = "Proposes a self-update to Jaider's own codebase by providing a file path (relative to the project root), a diff in the standard unified diff format (e.g., generated by `diff -u` or `git diff`), and an optional commit message. This stages the update for user review and approval before application.")
     ...
     */
    @Tool(name = "proposeSelfUpdate",
          description = "Proposes a self-update to Jaider's own codebase by providing a file path (relative to the project root) and a diff in the standard unified diff format (e.g., generated by `diff -u` or `git diff`). A default commit message will be generated. This stages the update for user review and approval before application.")
