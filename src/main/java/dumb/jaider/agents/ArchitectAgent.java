...
public class ArchitectAgent extends AbstractAgent {
    public ArchitectAgent(ChatModel model, ChatMemory memory, StandardTools availableTools) { // Changed from ChatLanguageModel
    ...
    protected ArchitectAgent(ChatModel model, ChatMemory memory, StandardTools availableTools, JaiderAiService aiService) { // Changed from ChatLanguageModel
