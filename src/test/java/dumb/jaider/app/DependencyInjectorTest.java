...
public class DependencyInjectorTest {
    ...
    private JSONObject defineComponentWithFactory(String id, String className, String factoryMethod) {
        var def = defineComponent(id, className);
    ...
    void testRegisterAndGetComponent_simpleSingleton() {
        ...
        var instance1 = (ComponentA) injector.getComponent("compA_id");
        assertNotNull(instance1);
        assertEquals("ComponentA_DefaultName", instance1.name);
        var instance2 = (ComponentA) injector.getComponent("compA_id");
    ...
    void testGetComponent_constructorWithDirectValues() {
        var definition = defineComponent("compVal_id", "dumb.jaider.app.DependencyInjectorTest$ComponentWithValCon");
        var ctorArgs = createArgsArray()
        ...
        injector = new DependencyInjector(new HashMap<>(componentDefinitions));
        var instance = (ComponentWithValCon) injector.getComponent("compVal_id");
    ...
    void testGetComponent_constructorWithMixedArgsRefAndValue() {
        ...
        var defMixed = defineComponent("compMixed_id", "dumb.jaider.app.DependencyInjectorTest$ComponentWithMixedCon");
        var ctorArgsMixed = createArgsArray()
        ...
        injector = new DependencyInjector(new HashMap<>(componentDefinitions));
        var instanceMixed = (ComponentWithMixedCon) injector.getComponent("compMixed_id");
        ...
        var instanceA = (ComponentA) injector.getComponent("compA_ref_id");
    ...
    void testGetComponent_constructorWithRefDependencies() {
        ...
        var defB = defineComponent("compB_with_dep_id", "dumb.jaider.app.DependencyInjectorTest$ComponentBWithDep");
        defB.put("constructorArgs", createArgsArray().put(createRefArg("compA_dep_id")));
        injector = new DependencyInjector(new HashMap<>(componentDefinitions));
        var instanceB = (ComponentBWithDep) injector.getComponent("compB_with_dep_id");
    ...
    void testGetComponent_constructorWithListOfValues() {
        var def = defineComponent("listValComp_id", "dumb.jaider.app.DependencyInjectorTest$ComponentWithListVal");
        var stringListJson = createArgsArray()
        ...
        injector = new DependencyInjector(new HashMap<>(componentDefinitions));
        var instance = (ComponentWithListVal) injector.getComponent("listValComp_id");
        assertNotNull(instance);
    ...
    void testGetComponent_constructorWithListOfRefs() {
        ...
        var def = defineComponent("listRefComp_id", "dumb.jaider.app.DependencyInjectorTest$ComponentWithListRef");
        var refListJson = createArgsArray()
        ...
        injector = new DependencyInjector(new HashMap<>(componentDefinitions));
        var instance = (ComponentWithListRef) injector.getComponent("listRefComp_id");
        assertNotNull(instance);
    ...
    void testGetComponent_constructorWithListOfMixedValuesAndRefs() {
        ...
        var def = defineComponent("listMixedComp_id", "dumb.jaider.app.DependencyInjectorTest$ComponentWithListMixed");
        var mixedJsonElArray = createArgsArray()
        ...
        injector = new DependencyInjector(new HashMap<>(componentDefinitions));
        var instance = (ComponentWithListMixed) injector.getComponent("listMixedComp_id");
        assertNotNull(instance);
    ...
    void testGetComponent_staticFactoryMethod_noArgs() {
        ...
        var instance = (ComponentWithStaticFactoryNoArgs) injector.getComponent("factoryNoArgs_id");
        assertNotNull(instance);
    ...
    void testGetComponent_staticFactoryMethod_withArgs() {
        ...
        var def = defineComponentWithFactory("factoryWithArgs_id", "dumb.jaider.app.DependencyInjectorTest$ComponentWithStaticFactoryWithArgs", "createInstance");
        var factoryMethodArgs = createArgsArray()
        ...
        injector = new DependencyInjector(new HashMap<>(componentDefinitions));
        var instance = (ComponentWithStaticFactoryWithArgs) injector.getComponent("factoryWithArgs_id");
        assertNotNull(instance);
    ...
    void testGetComponent_staticFactoryMethod_withListArgs() {
        ...
        var def = defineComponentWithFactory("factoryListArgs_id", "dumb.jaider.app.DependencyInjectorTest$ComponentWithStaticFactoryWithListArgs", "createInstance");
        var factoryStringListJson = createArgsArray()
                .put(createValueArg("str1", "java.lang.String"))
                .put(createValueArg("str2", "java.lang.String"));
        var factoryRefListJson = createArgsArray()
        ...
        def.put("staticFactoryArgs", factoryMethodArgs);
        injector = new DependencyInjector(new HashMap<>(componentDefinitions));
        var instance = (ComponentWithStaticFactoryWithListArgs) injector.getComponent("factoryListArgs_id");
        assertNotNull(instance);
    ...
    void testGetComponent_invalidConfiguration_staticFactoryMethodArgMismatch_type() {
        ...
        var def = defineComponentWithFactory("factoryTypeMismatch_id", "dumb.jaider.app.DependencyInjectorTest$ComponentWithStaticFactoryWithArgs", "createInstance");
        var factoryArgs = createArgsArray()
    ...
    void testGetComponent_invalidConfiguration_constructorArgMismatch_type() {
        var def = defineComponent("ctorTypeMismatch_id", "dumb.jaider.app.DependencyInjectorTest$ComponentWithValCon");
        var ctorArgs = createArgsArray()
    ...
    void testGetComponent_invalidConfiguration_constructorArgMismatch_count() {
        var def = defineComponent("ctorArgCountMismatch_id", "dumb.jaider.app.DependencyInjectorTest$ComponentWithValCon");
        var ctorArgs = createArgsArray().put(createValueArg("short string", "java.lang.String"));
        def.put("constructorArgs", ctorArgs);
        injector = new DependencyInjector(new HashMap<>(componentDefinitions));
    ...
    void testCircularDependency_direct() {
        ...
        var defX = defineComponentInMap("compX_circular_id", "dumb.jaider.app.DependencyInjectorTest$CompX", circularDefs);
        defX.put("constructorArgs", createArgsArray().put(createRefArg("compY_circular_id")));
        var defY = defineComponentInMap("compY_circular_id", "dumb.jaider.app.DependencyInjectorTest$CompY", circularDefs);
    ...
    void testCircularDependency_indirect() {
        ...
        var defX = defineComponentInMap("compX_indirect_id", "dumb.jaider.app.DependencyInjectorTest$CompX", indirectCircularDefs);
        defX.put("constructorArgs", createArgsArray().put(createRefArg("compY_indirect_id")));
        var defY = defineComponentInMap("compY_indirect_id", "dumb.jaider.app.DependencyInjectorTest$CompY", indirectCircularDefs);
        defY.put("constructorArgs", createArgsArray().put(createRefArg("compZ_indirect_id")));
        var defZ = defineComponentInMap("compZ_indirect_id", "dumb.jaider.app.DependencyInjectorTest$CompZ", indirectCircularDefs);
    ...
    void testClearCache_componentsRecreated() {
        ...
        var instanceOne = (ComponentA) injector.getComponent("compA_cache_test_id");
        injector.clearCache();
        var instanceTwo = (ComponentA) injector.getComponent("compA_cache_test_id");
    ...
    void testRegisterSingleton_instanceAlreadyCreated() {
        var manualExternalInstance = new ComponentA();
        ...
        var retrievedInst = (ComponentA) injector.getComponent("manualCompA_id");
        assertSame(manualExternalInstance, retrievedInst);
        assertEquals("ManuallyRegisteredExternalInstance", retrievedInst.name);

        var retrievedInst2 = (ComponentA) injector.getComponent("manualCompA_id");
        assertSame(manualExternalInstance, retrievedInst2);

        injector.clearCache();
        var retrievedAfterClear = (ComponentA) injector.getComponent("manualCompA_id");
